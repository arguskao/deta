        ...
        <div className="flex flex-col p-30px pt-0">
          ...
          <div className="flex w-full flex-col">
            <div className="flex flex-col justify-start full mt-10 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-2">成分組成</span>
            ...
            <div className="flex flex-col justify-start full mt-10 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-2">份量包裝</span>
              <span className="font-normal text-13px text-gray-900 capitalize">
                {state.item.dosage}
              </span>
            </div>
            ...
            <div className="flex flex-col justify-start full mt-10 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-2">製造廠</span>
              <span className="font-normal text-13px text-gray-900 capitalize">
